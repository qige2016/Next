...
#pragma warning restore CA1819 // 属性不应返回数组
        ...
        public uint ReadUint()
        {
            ...
            {
                EnsureRead(4);
                uint x = ((h & 0x0f) << 24) | ((uint) Bytes[ReaderIndex + 1] << 16) |
            ...
            {
                EnsureRead(5);
                uint x = ((uint) Bytes[ReaderIndex + 1] << 24) | ((uint) (Bytes[ReaderIndex + 2] << 16)) |
        ...
        public ulong ReadUlong()
        {
            ...
            {
                EnsureRead(5);
                uint xl = ((uint) Bytes[ReaderIndex + 1] << 24) | ((uint) (Bytes[ReaderIndex + 2] << 16)) |
                          ((uint) Bytes[ReaderIndex + 3] << 8) | (Bytes[ReaderIndex + 4]);
                uint xh = h & 0x07;
                ReaderIndex += 5;
            ...
            {
                EnsureRead(6);
                uint xl = ((uint) Bytes[ReaderIndex + 2] << 24) | ((uint) (Bytes[ReaderIndex + 3] << 16)) |
            ...
            {
                EnsureRead(7);
                uint xl = ((uint) Bytes[ReaderIndex + 3] << 24) | ((uint) (Bytes[ReaderIndex + 4] << 16)) |
            ...
            {
                EnsureRead(8);
                uint xl = ((uint) Bytes[ReaderIndex + 4] << 24) | ((uint) (Bytes[ReaderIndex + 5] << 16)) |
                          ((uint) Bytes[ReaderIndex + 6] << 8) | (Bytes[ReaderIndex + 7]);
                uint xh = /*((h & 0x01) << 24) |*/ ((uint) Bytes[ReaderIndex + 1] << 16) |
                                                   ((uint) Bytes[ReaderIndex + 2] << 8) | Bytes[ReaderIndex + 3];
                ReaderIndex += 8;
                return ((ulong) xh << 32) | xl;
            }
            ...
            {
                EnsureRead(9);
                uint xl = ((uint) Bytes[ReaderIndex + 5] << 24) | ((uint) (Bytes[ReaderIndex + 6] << 16)) |
                          ((uint) Bytes[ReaderIndex + 7] << 8) | (Bytes[ReaderIndex + 8]);
                uint xh = ((uint) Bytes[ReaderIndex + 1] << 24) | ((uint) Bytes[ReaderIndex + 2] << 16) |
                          ((uint) Bytes[ReaderIndex + 3] << 8) | Bytes[ReaderIndex + 4];
                ReaderIndex += 9;
                return ((ulong) xh << 32) | xl;
            }
...
#else
            int xl = (Bytes[ReaderIndex + 3] << 24) | ((Bytes[ReaderIndex + 2] << 16)) | (Bytes[ReaderIndex + 1] << 8) |
                     (Bytes[ReaderIndex]);
            int xh = (Bytes[ReaderIndex + 7] << 24) | (Bytes[ReaderIndex + 6] << 16) | (Bytes[ReaderIndex + 5] << 8) |
                     Bytes[ReaderIndex + 4];
        ...
        public void ReadSegment(out int startIndex, out int segmentSize)
        {
            ...
            {
                EnsureRead(3);
                segmentSize = ((h & 0x0f) << 24) | ((int) Bytes[ReaderIndex] << 16) |
                              ((int) Bytes[ReaderIndex + 1] << 8) | Bytes[ReaderIndex + 2];
                int endPos = ReaderIndex + segmentSize;
                Bytes[ReaderIndex] = Bytes[endPos];
                Bytes[ReaderIndex + 1] = Bytes[endPos + 1];
